...
> Yaw에 상대좌표 개념 도입.. Yaw는 드리프트만 막고 컨트롤로 제어!

[동영상링크](https://youtu.be/UTnxOHgIfPE)


## issue
> yaw 값을 컨트롤로 잡아도 출력 높이면 yaw 잡아주는 것도 높여야 함

> 이걸 출력의 비율로 증가시키면 되지 않을까 싶음
...
> API 문서 받아서 홈페이지 올릴 부분 해놓기

# 2015-11-8

### 진행상황

> MPU6050 으로 Yaw 값 구해서 모터제어 연산에 추가.

> 최악이다. 빙글빙글 빙그르르르

## issue

> 방향전환시 딱 그 방향으로 기울어지는게 아니라 대각선으로 기울어지면서 빙빙 도는 현상 발생.

## 다음 할일
> 자꾸 배터리 충전에 문제가 생김.. 쉽게 방전되어버리는 문제... 알아보기
...
> 지자기센서 추가 및 MPU6050 사용

> 시범비행날. -> 결국 시범비행 못함

## issue

> 지자기센서가 금속에 매우 민감해서 정확한 값을 구하기가 어렵다.


## 다음 할일

> MPU6050 만으로 정확한 값 구하기

# 2015-10-27

### 진행상황
> PiDrone 홈페이지 제작 -> 별도의 호스팅 없이 GitHub Pages 이용

> http://soma6th.github.io

> 소스트리 구조 변경  drone.h 만 인클루드 해서 모든 함수 사용 가능.

> 다른 드론 소스코드 다 뒤져서 빠진 부분 있는지 확인
...
### 진행상황
> 드론 테스트 프레임 책상 뒤집어서 만들어버림..
![](./image/newTest1.jpeg)
![](./image/newTest2.jpeg)


## issue
> yaw 오차때문에 문제 발생. 써도 문제 안써도 문제..
- 쓸 경우 : yaw 오차가 크게벌어지면 (13) (24) 회전수 차이로 불안정
- 안 쓸 경우 : 진짜 오직 운에 의해서 안돌아가길 바래야함..
- 실밥 터짐...아프다...
...
### 진행상황
> PID 알고리즘 교체. 실시간 dt 값으로 변경. -> 많이 나아짐
