...
> Motor 인터페이스 구성. 복붙해서 각 장치에 맞게 구현하면 됨... 근데 이구조가... 맞는 구조일까..?


### issue

> softPwm 은 AVR 의 하드웨어적 PWM 만드는 방식과 다름... 쓰레드를 별도 생성 관리해야 함...

> 해결방안

> 1. 각 motor 객체에서 쓰레드를 관리. 새로운 값 입력시 기존 쓰레드 죽이고 새로 생성..!

> 2. 일단 Thread 중복 생성해보고 파형 잘 나오는지 확인해보기 -> 이거 되더라도 오래 돌렸을때 쓰레드 점유율 많이먹나 확인해보기
